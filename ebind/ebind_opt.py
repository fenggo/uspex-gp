...
parser.add_argument('--i', default=-1,type=int, help='index of atomic frame')
...
if not exists('ebind_opt.dat'):
   with open('ebind_opt.dat','w') as fd:
        print('# Crystal_id lattice_energy molecular_gas_energy binding_energy average_ebind density',file=fd)

moleclue_energy = {'C2N4H4O4'   : -3188.837170,  #   -3188.850430
                   'C6N12O12H6' : -9464.452610,  #   -9464.537080
                   'C7H5N3O6'   : -4574.365840
                    }  #    eV
#        Molecular Energy C2N4H4O4  : -3188.850040  -3188.842320
#        Molecular Energy C2N4H4O4  : -3188.842200
#        Molecular Energy C2N4H4O4  : -3188.844980
#        Molecular Energy C6N12O12H6: -9464.581880  -9464.535990
#        Molecular Energy C6N12O12H6: -9464.527320
#        Molecular Energy C2N4H4O4  : -3188.842320
#        Molecular Energy C6N12O12H6: -9464.481120
#        Molecular Energy C4N8O8H8  : -6374.505990
#        Molecular Energy C6N12O12H6: -9464.571710
#        

for stru in ids:
    if stru.endswith('.gen') or stru.endswith('.traj') or stru.startswith('POSCAR'):
        if stru.endswith('.svg'):
           continue
        A = read(stru)
        A = press_mol(A)
        x = A.get_positions()
        ...
        for m in m_:
            if m.label not in moleclue_energy:
               ...
               atoms = moltoatoms([m])
               img = siesta_opt(atoms,ncpu=args.n,us='F',VariableCell='false',tstep=300,
                                xcf=xcf,xca=xca,basistype='split')
        ...
        chdir(cdir)
        with open('ebind_opt.dat','a') as fd:
