...
% disp(ORG_STRUC.varcomp)
% disp(ORG_STRUC.dimension)

if (ORG_STRUC.dimension==3)  &&  (ORG_STRUC.varcomp==1)                    % 31'0'  是否变组分计算
...
%disp(['calling initialize_POP_STRUC_' calcType_str])

eval(['initialize_POP_STRUC_' calcType_str '()']);     % 执行 initialize_POP_STRUC_310
