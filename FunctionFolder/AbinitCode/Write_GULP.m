...
%   [a,b] = unix('mv optimized.structure opt.res');
%end
...
% else
   ...
   fp = fopen('input_orderd','w');
   fprintf(fp, 'grad nosymmetry conv qiterative \n');
   fprintf(fp, 'cell\n');
   ...
   fprintf(fp, 'library reaxff_nn\n');
   fprintf(fp, 'output cif gulp\n');
   fclose(fp);
% end
